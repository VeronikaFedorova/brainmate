      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border border-n-1/10 lg:right-auto lg:left-1/2 lg:bottom-8 lg:-translate-x-1/2" />
          </div>
            ...
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                  ...
                  <p className="body-2 mb-[3rem] text-n-3">
                    Automatically enhance your photos using our app&apos;s photo
                    editing featire. Try it now!
                  </p>
                </div>
                <PhotoChatMessage />
              </div>
            </div>
            <div className="p-4 bg-n-7 rouded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <h4 className="h4 mb-4">Video generation</h4>
                <p className="body-2 mb-[2rem] text-n-3">
                  The world&apos;s mosr powerful AI photo and video art
